    ...
    <main>
       ...
       <div class="main-box top">
          ...
          <div class="top">
            ...
            <div class="box">
            <a href="home.php"> <button class="btn">Received Files</button> </a>
            </div>
            <div class="box">
          ...
          <div class="bottom">
            ...
            <div class="box">
                ...
                <center><u><p class = "logo">UPLOAD YOUR FILES</p></u></center>
                <br>

             <center><div class="box form-box">

                <form action="php/uploadFiles.inc.php" method="post" enctype="multipart/form-data">
            
                <input type="hidden" name="userId" value="<?php echo $_SESSION['U_ID']; ?>">
                <input type="hidden" name="empid" value="<?php echo $res_id; ?>" >
