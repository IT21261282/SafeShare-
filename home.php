    ...
    <main>
       ...
       <div class="main-box top">
          ...
          <div class="bottom">
            ...
            <div class="box">
                <center><u><p class = "logo">YOUR RECEIVED FILES</p></u></center>
                <br>
                <?php
                        $sql = "SELECT * FROM files WHERE empId = ?; ";
                        ...
                        if(mysqli_num_rows($resultsData) > 0) {
                            ...
                            echo "<table>";
                            echo "<tr><th>File ID</th><th>File Name</th><th>Special Notes</th><th>Sender</th><th>Actions</th></tr>";
                            ...
                            while ($row = mysqli_fetch_assoc($resultsData)) {
                                ...
                                echo "<td>" . $row['spcNotes'] . "</td>";
                                echo "<td>" . $row['sender'] . "</td>";
                                echo "<td>";
                                echo "<a href='php/download.inc.php?fileID=" . $row['fileID'] . "' class= 'download-link'>Download</a> ";
